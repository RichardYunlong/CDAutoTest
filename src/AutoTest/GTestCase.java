...
public class GTestCase {
	 ...
	 *  测试名称
	 */
	public static String dTSName = "";
	
	/**
	 *  测试动作
	 */
	public static String dTSAction = "";
	
	/**
	 *  测试概述
	 */
	public static String dTSScription = "";
	
	/**
	 *  测试过程记录
	 */
	public static String dTSRecord = "";
	 ...
	 *  用例名称或简单描述
	 */
	private static String TestCaseSpt = "测试用例描述";
	
	/**
	 *  用例执行结果
	 */
	private static boolean TestCaseRst = false;
	
	/**
	 * 设置用例名称或简单描述
	 */
	public static void setTestCaseSpt(String src) {
		TestCaseSpt = src;
	}
	 ...
	 * 获得用例名称或简单描述
	 */
	public static String getTestCaseSpt() {
		return TestCaseSpt;
	}
	 ...
	 * 设置用例结果
	 */
	public static void setTestCaseRst(boolean boo) {
		TestCaseRst = boo;
	}
	 ...
	 * 获得用例执行结果
	 */
	public static boolean getTestCaseRst() {
		return TestCaseRst;
	}
}
