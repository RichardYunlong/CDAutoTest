...
public class GPath {
	 ...
	 * image版本测试报告-存储位置
	 */
	public static final String IMAGEREPORT_PATH = REPORT_PATH + "./image_report/";
     ...
     *  浏览器驱动下载位置
     */
    public static final String WEBDRIVER_DOWNLOADS_PATH = "./driver/chrome/";

    /**
     *  json配置文件-存储位置
     */
    public static final String JSON_TEMP_PATH = "json/";

    /**
     *  图片-存储位置
     */
    public static final String IMAGE_TEMP_PATH = "image/";
     ...
     *  测试相关临时文件-存储位置
     */
    public static final String TEST_TEMP_PATH = "test/";

    /**
     *  页面相关临时文件-存储位置
     */
    public static final String HTML_TEMP_PATH = "html/";

    /**
     *  input输入文件-存储位置
     */
    public static final String INPUT_TEMP_PATH = "input/";

    /**
     *  font输入文件-存储位置
     */
    public static final String FONT_TEMP_PATH = "input/";
	...
	public static void setDefault(){
		...
		GFile.clearDirectory(GPath.IMAGEREPORT_PATH);
