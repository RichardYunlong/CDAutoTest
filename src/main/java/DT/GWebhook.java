...
public class GWebhook {
    ...
    // 这里就是刚才拿到的Webhook的值
    public final String WebHookUrl = "https://c2.yonyoucloud.com/yonbip-ec-link/intelligent-robot/system/send?accessToken=2165197244333031435";
    ...
    public void sendMessage(String msg) {
        ...
        String result = HttpRequest.post(WebHookUrl).body(JSON.toJSONString(json), "application/json;charset=UTF-8")
                .execute().body();
