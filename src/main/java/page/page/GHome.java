...
import page.widget.Header;
import page.widget.MenuWarp;
import page.widget.Setting;
import page.widget.TopTab;
import page.widget.Workbench;
	...
	public void openMenuWarp(WebDriver webDriver) {
		...
		if (null != menuWarpTemp) {
			...
			GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
					GParam.getCssSelectorBy3K("菜单内容"));
			GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
					GParam.getCssSelectorBy3K("菜单左侧区域"));
			GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
					GParam.getCssSelectorBy3K("菜单右侧区域"));
			GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
					GParam.getCssSelectorBy3K("菜单右侧区域_三级菜单"));
