...
import page.baseused.SecondWinBase;

public class AddUser extends SecondWinBase {
     ...
     * */
    public AddUser(WebDriver webDriver, String locateTagName, String locateAtrributeName, String locateArributeValue){
