...
public class MenuWarp extends UniqueWebElementBase {
	...
	public MenuWarp(WebDriver webDriver, String cssSelector) {
		...
		GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
				GParam.getCssSelectorBy3K("菜单左侧区域"));
	...
	private void reloadNavbarRight(WebDriver webDriver) {
		GWCtrlWait.ViewWaitingAllByCssSelector(webDriver, GTestIndicators.PageShowTime,
				GParam.getCssSelectorBy3K("菜单右侧区域"));
	...
	private void chooseProduct(WebDriver webDriver, String product) {
		menuScrollAreaByTitleLevel3 = new MenuScrollAreaByTitle(webDriver,
				navbarRight.findElement(By.cssSelector(GParam.getCssSelectorBy3K("菜单活跃区域"))));
	...
	private void chooseModule(WebDriver webDriver, String module) {
		menuScrollAreaByTLabelLevel4 = new MenuScrollAreaByLabel(webDriver,
				navbarRight.findElement(By.cssSelector(GParam.getCssSelectorBy3K("菜单活跃区域"))));
		// noinspection ConstantValue
	...
	private void chooseNode(WebDriver webDriver, String node) {
		menuScrollAreaBySpanLevel5 = new MenuScrollAreaBySpan(webDriver,
				navbarRight.findElement(By.cssSelector(GParam.getCssSelectorBy3K("菜单活跃区域"))));
		// noinspection ConstantValue
