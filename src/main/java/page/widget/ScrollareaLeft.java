...
public class ScrollareaLeft {
	...
	public ScrollareaLeft(WebDriver webDriver, WebElement root) {
		...
		if(!menuLevel1.getWebElementArrayList().isEmpty()) {
			GLog.logRecordTime(9, "加载菜单树一级菜单[" + menuLevel1.getStringArrayList().toString() + "]成功");
		}
	}
	...
	public void clickMenuLevel1(WebDriver webDriver, String dir) {
		...
		if(!menuLevel2.getWebElementArrayList().isEmpty()) {
			GLog.logRecordTime(9, "加载菜单树二级菜单[" + menuLevel2.getStringArrayList().toString() + "]成功");
		}
	}
