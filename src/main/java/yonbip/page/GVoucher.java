...
import main.java.yonbip.base.VoucherBase;
import main.java.yonbip.base.WebElementArrayList;
import main.java.yonbip.table.VoucherTable;
...
public class GVoucher {
	 ...
	 *  页面的WebElement对象
	 */
	VoucherBase voucherRoot = null;
	
	/**
	 *  工具按钮表
	 */
	private WebElementArrayList toolBar = null;
